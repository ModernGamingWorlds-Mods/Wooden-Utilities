...
import com.moderngamingworld.woodenutilities.WoodenLayeredCauldronBlock;
...
public final class ModBlocks {
    ...
    private static final String[] WOODEN_CAULDRON_IDS = new String[] {
        "wooden_cauldron", "oak_wooden_cauldron", "spruce_wooden_cauldron", "birch_wooden_cauldron",
        "jungle_wooden_cauldron", "acacia_wooden_cauldron", "dark_oak_wooden_cauldron", "mangrove_wooden_cauldron",
        "cherry_wooden_cauldron", "bamboo_wooden_cauldron", "crimson_wooden_cauldron", "warped_wooden_cauldron",
        "twilight_oak_wooden_cauldron", "canopy_wooden_cauldron", "twilight_mangrove_wooden_cauldron", "dark_wooden_cauldron",
        "time_wooden_cauldron", "transformation_wooden_cauldron", "mining_wooden_cauldron", "sorting_wooden_cauldron",
        "towerwood_wooden_cauldron", "fir_wooden_cauldron", "pine_wooden_cauldron", "maple_wooden_cauldron",
        "redwood_wooden_cauldron", "mahogany_wooden_cauldron", "jacaranda_wooden_cauldron", "palm_wooden_cauldron",
        "willow_wooden_cauldron", "dead_wooden_cauldron", "magic_wooden_cauldron", "umbran_wooden_cauldron",
        "hellbark_wooden_cauldron", "empyreal_wooden_cauldron", "roseroot_wooden_cauldron", "yagroot_wooden_cauldron",
        "cruderoot_wooden_cauldron", "conberry_wooden_cauldron", "sunroot_wooden_cauldron", "skyroot_wooden_cauldron"
    };

    static {
        for (String id : WOODEN_CAULDRON_IDS) {
            BLOCKS.register(id.replace("_cauldron", "_water_cauldron"),
                () -> new WoodenLayeredCauldronBlock(BlockBehaviour.Properties.copy(Blocks.WATER_CAULDRON)));
        }
    }
